...
// ---------------------------------------------------------------------------
import { isConfigured, SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=52';
import { toast, esc } from './ui.js?v=52';
...
const db = await import('./db.js?v=52');
const agentViews = await import('./views-agent.js?v=52');
const adminViews = await import('./views-admin.js?v=52');
const scoringViews = await import('./views-scoring.js?v=52');
const rubricViews = await import('./views-rubric.js?v=52');
const accountViews = await import('./views-account.js?v=52');
const analyticsViews = await import('./views-analytics.js?v=52');
