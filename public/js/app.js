...
// ---------------------------------------------------------------------------
import { isConfigured, SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=44';
import { toast, esc } from './ui.js?v=44';
...
const db = await import('./db.js?v=44');
const agentViews = await import('./views-agent.js?v=44');
const adminViews = await import('./views-admin.js?v=44');
const scoringViews = await import('./views-scoring.js?v=44');
const rubricViews = await import('./views-rubric.js?v=44');
const accountViews = await import('./views-account.js?v=44');
