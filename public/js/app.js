...
// ---------------------------------------------------------------------------
import { isConfigured, SUPABASE_URL, SUPABASE_ANON_KEY } from './config.js?v=43';
import { toast, esc } from './ui.js?v=43';
...
const db = await import('./db.js?v=43');
const agentViews = await import('./views-agent.js?v=43');
const adminViews = await import('./views-admin.js?v=43');
const scoringViews = await import('./views-scoring.js?v=43');
const rubricViews = await import('./views-rubric.js?v=43');
const accountViews = await import('./views-account.js?v=43');
