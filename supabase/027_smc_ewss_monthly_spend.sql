-- ============================================================================
-- Lana — migration 027: SMC and EWSS Monthly spend on the Dashboard
--
-- Additive. Run after 026. Safe to re-run.
--
-- Per Ryan 2026-09-20: the monthly counterparts to 024/026's SMC/EWSS daily
-- and weekly tiles, needed for the requested Dashboard layout — same two
-- cost sources (AI grading, AI review/manual-summary), same team
-- resolution, same no-transcription-cost caveat.
--
...
-- migrations 015, 018, 022, 023, 024, 025 and 026 needed it).
-- ============================================================================
